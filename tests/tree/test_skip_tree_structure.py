...
def test_nodes():
    ...
    print(st.hash.hex())
    print(structure)
    assert st.hash == b'\xc0\xfc\xf4\xb2W\x16"\x90]\xde\x08\x84\xefV\xd4\x94\xad4\x81\xd2\x8f\xa1gFo\x97\x0f,c>)%'
   ...
   O   O         O   O
    ...
    assert SubTree.structure_to_bins(structure) == [(0, 2), (2, 4), (4, 8), (8, 12), (12, 14), (14, 16)]
    st = SubTree(structure, nodes)
